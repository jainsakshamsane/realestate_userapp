...
public class CategoryDetailsActivity extends AppCompatActivity {
    ...
    PropertyCategoryAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            typee.setText(proptype);
        }

        DatabaseReference categoryRef = FirebaseDatabase.getInstance().getReference("Property");

        adapter = new PropertyCategoryAdapter(this, propertyModels);

        categoryRef.orderByChild("propertyType").equalTo(proptype).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
