...
import com.realestate_userapp.Adapters.RentAdapter;
...
public class SaleTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.saletype_activity);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(SaleTypeActivity.this, LinearLayoutManager.VERTICAL, false);
        ...
        categoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (saletype.equals(selectedtype)) {
